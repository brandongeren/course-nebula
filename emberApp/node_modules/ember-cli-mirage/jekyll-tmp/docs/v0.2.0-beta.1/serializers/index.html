...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.1/serializers/">
    Serializers
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.1/serializers.md">
          <small>
...
<p>Mirage ships with two named serializers. Use <strong>JsonApiSerializer</strong> to mock out JSON:API compliant servers:</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="c1">// mirage/serializers/application.js</span>
<span class="kr">import</span> <span class="nx">JsonApiSerializer</span> <span class="nx">from</span> <span class="s1">'ember-cli-mirage/serializers/json-api-serializer'</span><span class="p">;</span>

<span class="kr">export</span> <span class="k">default</span> <span class="nx">JsonApiSerializer</span><span class="p">;</span>
</code></pre>
</div>

<p>Use <strong>ActiveModelSerializer</strong> to mock out Rails backends that use AMS-style responses:</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="c1">// mirage/serializers/application.js</span>
<span class="kr">import</span> <span class="nx">ActiveModelSerializer</span> <span class="nx">from</span> <span class="s1">'ember-cli-mirage/serializers/active-model-serializer'</span>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">BaseSerializer</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
  <span class="na">relationships</span><span class="p">:</span> <span class="p">[</span><span class="s1">'comments'</span><span class="p">]</span>
<span class="p">});</span>
</code></pre>
</div>
...
<p>and you wanted to sideload these, specify so in the <code class="highlighter-rouge">relationships</code> key:</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="c1">// mirage/serializers/authors.j</span>
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Serializer</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
...
<h2 id="keyformodeltype">keyForModel(<em>type</em>)</h2>

<p>Used to define a custom key when serializing a primary model of type <em>type</em>. For example, the default Serializer will return something like the following:</p>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Serializer</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
  <span class="nx">keyForModel</span><span class="p">(</span><span class="nx">type</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="nx">Ember</span><span class="p">.</span><span class="nb">String</span><span class="p">.</span><span class="nx">dasherize</span><span class="p">(</span><span class="nx">type</span><span class="p">);</span>
  <span class="p">}</span>
<span class="p">});</span>
</code></pre>
</div>
...
<h2 id="keyforcollectiontype">keyForCollection(<em>type</em>)</h2>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Serializer</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
  <span class="nx">keyForCollection</span><span class="p">(</span><span class="nx">type</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="nx">pluralize</span><span class="p">(</span><span class="nx">dasherize</span><span class="p">(</span><span class="nx">type</span><span class="p">));</span>
  <span class="p">}</span>
<span class="p">});</span>
</code></pre>
</div>
...
<h2 id="keyforrelationshiptype">keyForRelationship(<em>type</em>)</h2>

<p>Use this hook to format the key for collections
related to this model. <em>type</em> is the type of the relationship.</p>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Serializer</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
  <span class="nx">keyForRelationship</span><span class="p">(</span><span class="nx">type</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="nx">underscore</span><span class="p">(</span><span class="nx">attr</span><span class="p">);</span>
  <span class="p">}</span>
<span class="p">});</span>
</code></pre>
...
<h2 id="keyforrelationshipidstype">keyForRelationshipIds(<em>type</em>)</h2>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Serializer</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
  <span class="nx">keyForRelationshipIds</span><span class="p">(</span><span class="nx">type</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="nx">underscore</span><span class="p">(</span><span class="nx">type</span><span class="p">)</span> <span class="o">+</span> <span class="s1">'_ids'</span><span class="p">;</span>
  <span class="p">}</span>
<span class="p">});</span>
</code></pre>
</div>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.1/schema/">< Schema</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.1/shorthands/">Shorthands ></a>
