...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.3/defining-routes/">
    Defining routes
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.3/defining-routes.md">
          <small>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">'/authors'</span><span class="p">,</span> <span class="p">(</span><span class="nx">schema</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s1">'/authors'</span><span class="p">,</span> <span class="p">(</span><span class="nx">schema</span><span class="p">,</span> <span class="nx">request</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
  ...
  <span class="k">return</span> <span class="nx">schema</span><span class="p">.</span><span class="nx">author</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">attrs</span><span class="p">);</span>
<span class="p">});</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">'/authors/:id'</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">schema</span><span class="p">,</span> <span class="nx">request</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="k">return</span> <span class="nx">schema</span><span class="p">.</span><span class="nx">author</span><span class="p">.</span><span class="nx">find</span><span class="p">(</span><span class="nx">id</span><span class="p">);</span>
<span class="p">})</span>
</code></pre>
</div>
...
<p>Similarly, we wrote a mock by hand to deal with creating an author</p>
...
<p>Mirage ships with two named serializers, JsonApiSerializer (used to mock servers implementing <a href="http://jsonapi.org/">JSON:API</a>) and ActiveModelSerializer (used to mock Rails servers using ActiveModel::Serializers). You should use these if your app’s backend will be built to conform to either standard.</p>
...
<p>Just like in Ember, the <code class="highlighter-rouge">application/serializer.js</code> file will apply to all your responses. You can also create per-model serializers, for example to include only some attributes:</p>
...
<p>Route handlers for paths without a domain (e.g. <code class="highlighter-rouge">this.get('/authors')</code>) work for requests that target the current domain. To mock out other-origin requests, specify the fully qualified URL for your route handler:</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.3/quickstart/">< Quickstart</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.3/seeding-your-database/">Seeding your database ></a>
