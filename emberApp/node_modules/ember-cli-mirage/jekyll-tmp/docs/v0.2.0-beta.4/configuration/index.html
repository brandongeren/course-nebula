...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.4/configuration/">
    Configuration
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.4/configuration.md">
          <small>
...
<p>By default, if your Ember app maks a request that is not defined in your server config, Mirage will throw an error. You can use <code class="highlighter-rouge">passthrough</code> to whitelist requests, and allow them to pass through your Mirage server to the actual network layer.</p>
...
<p><a name="directory" href="#directory">#</a> ENV[‘ember-cli-mirage’].<b>directory</b></p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.4/acceptance-testing/">< Acceptance testing</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.4/collections/">Collections ></a>
