...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.4/models/">
    Models
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.4/models.md">
          <small>
...
<p>Boolean, true if the model has been persisted to the db.</p>
...
<p>If your associations model has a different name than the association itself, you can specify the model name on the association:</p>
...
<p>would add all the <code class="highlighter-rouge">author</code> and <code class="highlighter-rouge">comment</code> methods as listed above, but utilize a <code class="highlighter-rouge">user</code> instance and <code class="highlighter-rouge">annotation</code> instances.</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.4/fixtures/">< Fixtures</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.4/schema/">Schema ></a>
