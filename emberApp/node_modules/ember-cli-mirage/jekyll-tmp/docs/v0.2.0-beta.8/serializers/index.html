...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.8/serializers/">
    Serializers
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.8/serializers.md">
          <small>
...
<span class="kr">import</span> <span class="nx">JSONAPISerializer</span> <span class="nx">from</span> <span class="s1">'ember-cli-mirage'</span><span class="p">;</span>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">JsonApiSerializer</span><span class="p">;</span>
  ...
  <li>
    ...
    <div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="c1">// mirage/serializers/application.js</span>
<span class="kr">import</span> <span class="nx">ActiveModelSerializer</span> <span class="nx">from</span> <span class="s1">'ember-cli-mirage'</span>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">ActiveModelSerializer</span><span class="p">;</span>
  ...
  <li>
    ...
    <div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="c1">// mirage/serializers/application.js</span>
<span class="kr">import</span> <span class="p">{</span> <span class="nx">RestSerializer</span> <span class="p">}</span> <span class="nx">from</span> <span class="s1">'ember-cli-mirage'</span>
  ...
  <span class="nx">links</span><span class="p">(</span><span class="nx">author</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="p">{</span>
      <span class="s1">'posts'</span><span class="p">:</span> <span class="p">{</span>
        <span class="na">related</span><span class="p">:</span> <span class="err">`</span><span class="o">/</span><span class="nx">api</span><span class="o">/</span><span class="nx">authors</span><span class="o">/</span><span class="nx">$</span><span class="p">{</span><span class="nx">model</span><span class="p">.</span><span class="nx">id</span><span class="p">}</span><span class="sr">/posts</span><span class="err">`
</span>      <span class="p">}</span>
    <span class="p">};</span>
  <span class="p">}</span>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.8/schema/">< Schema</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.8/shorthands/">Shorthands ></a>
