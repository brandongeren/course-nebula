  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.10/models.md">
          <small>
...
<p>### findBy(<em>query</em>)</p>

<p>Return the first model in the database matching the key-value pairs in <em>query</em>.</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">let</span> <span class="nx">post</span> <span class="o">=</span> <span class="nx">blogPosts</span><span class="p">.</span><span class="nx">findBy</span><span class="p">({</span> <span class="na">slug</span><span class="p">:</span> <span class="s1">'top-five-reasons-you-should-use-mirage'</span> <span class="p">});</span>
</code></pre>
</div>
