  ...
  _createClass(GetShorthandRouteHandler, [{
    ...
    */
    value: function handleStringShorthand(request, modelClass) {
      ...
      assert(modelClass, 'The route handler for ' + request.url + ' is trying to access the ' + camelizedModelName + ' model, but that model doesn\'t exist. Create it using \'ember g mirage-model ' + modelName + '\'.');
