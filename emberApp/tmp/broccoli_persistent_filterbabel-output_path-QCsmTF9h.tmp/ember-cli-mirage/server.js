define('ember-cli-mirage/server', ['exports', 'ember-cli-mirage/utils/inflector', 'ember-cli-mirage/utils/normalize-name', 'ember', 'ember-cli-mirage/utils/is-association', 'pretender', 'ember-cli-mirage/db', 'ember-cli-mirage/orm/schema', 'ember-cli-mirage/assert', 'ember-cli-mirage/serializer-registry', 'ember-cli-mirage/route-handler', 'lodash/pick', 'lodash/assign', 'lodash/find', 'lodash/isPlainObject'], function (exports, _emberCliMirageUtilsInflector, _emberCliMirageUtilsNormalizeName, _ember, _emberCliMirageUtilsIsAssociation, _pretender, _emberCliMirageDb, _emberCliMirageOrmSchema, _emberCliMirageAssert, _emberCliMirageSerializerRegistry, _emberCliMirageRouteHandler, _lodashPick, _lodashAssign, _lodashFind, _lodashIsPlainObject) {
  'use strict';
    ...
    _createClass(Server, [{
      ...
      */
      ...
      value: function buildList(type, amount) {
        (0, _emberCliMirageAssert['default'])(Number.isInteger(amount), 'second argument has to be an integer, you passed: ' + typeof amount);
