...
Store = Service.extend({
  ...
  _flushPendingFetchForType: function _flushPendingFetchForType(pendingFetchItems, modelClass) {
    ...
    if (shouldCoalesce) {
      ...
      var _loop = function (i, l) {
        ...
        if (totalInGroup > 1) {
          _findMany(adapter, store, modelClass, ids, groupedInternalModels).then(function (foundInternalModels) {
  ...
  */
  ...
  _query: function _query(modelName, query, array) {
    ...
    var pA = promiseArray(_query3(adapter, this, modelClass, query, array));
  ...
  */
  queryRecord: function queryRecord(modelName, query) {
    ...
    return promiseObject(_queryRecord(adapter, this, modelClass, query).then(function (internalModel) {
  ...
  */
  ...
  modelFactoryFor: function modelFactoryFor(modelName) {
    ...
    var trueModelName = normalizeModelName(modelName);
    var owner = getOwner(this);
  ...
  */
  buildInternalModel: function buildInternalModel(modelClass, id, data) {
    ...
    var internalModel = new InternalModel(modelClass, id, this, data);
