	...
	exports['default'] = _ember['default'].Controller.extend({
		...
		actions: {
			answerquestion: function answerquestion() {
				...
				var date = new Date();
				var aquestion = this.get('store').findRecord('question', this.get('questionID'));
				var rating = 1;
...
if (!runningTests) {
  require("course-nebula/app")["default"].create({"contentSecurityPolicy":{"default-src":"'none'","script-src":"'self' 'unsafe-inline' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","img-src":"'self'","report-uri":"'localhost'","style-src":"'self' 'unsafe-inline'","frame-src":"'none'"},"name":"course-nebula","version":"0.0.0+3886f717"});
}
