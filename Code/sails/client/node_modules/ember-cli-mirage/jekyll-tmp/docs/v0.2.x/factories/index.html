...
<p>When building objects using factories, you may want to create related objects automatically. To build related objects, you can use <code class="highlighter-rouge">association</code> helper.</p>
...
<p>You can also use the <code class="highlighter-rouge">afterCreate()</code> hook:</p>
