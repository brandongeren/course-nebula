...
<option value="/docs/v0.2.0-beta.3/">Overview</option>
...
<option value="/docs/v0.2.0-beta.3/installing-and-updating/">Installing and Updating</option>
...
<option value="/docs/v0.2.0-beta.3/changelog/">Changelog</option>
...
<option value="/docs/v0.2.0-beta.3/quickstart/">Quickstart</option>
...
<option value="/docs/v0.2.0-beta.3/defining-routes/">Defining routes</option>
...
<option value="/docs/v0.2.0-beta.3/seeding-your-database/">Seeding your database</option>
...
<option value="/docs/v0.2.0-beta.3/acceptance-testing/">Acceptance testing</option>
...
<option value="/docs/v0.2.0-beta.3/configuration/">Configuration</option>
...
<option value="/docs/v0.2.0-beta.3/collections/">Collections</option>
...
<option value="/docs/v0.2.0-beta.3/route-handlers/">Route handlers</option>
...
<option value="/docs/v0.2.0-beta.3/database/">Database</option>
...
<option value="/docs/v0.2.0-beta.3/factories/">Factories</option>
...
<option value="/docs/v0.2.0-beta.3/fixtures/">Fixtures</option>
...
<option value="/docs/v0.2.0-beta.3/models/">Models</option>
...
<option value="/docs/v0.2.0-beta.3/schema/">Schema</option>
...
<option value="/docs/v0.2.0-beta.3/serializers/">Serializers</option>
...
<option value="/docs/v0.2.0-beta.3/shorthands/">Shorthands</option>
...
<option value="/docs/v0.2.0-beta.3/manually-starting-mirage/">Manually starting Mirage</option>
...
<option value="/docs/v0.2.0-beta.3/simulating-cookie-responses/">Simulating cookie responses</option>
    ...
    <div class="Mobile-nav__version">
      ...
      <select class='Mobile-nav__version-select' onchange="if (this.value) window.location.href=this.value">
          ...
          <option value="/docs/v0.2.0-beta.3" selected >v0.2.0-beta.3</option>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/">
    Overview
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/installing-and-updating/">
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/changelog/">
    Changelog
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.3/quickstart/">
    Quickstart
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/defining-routes/">
    Defining routes
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/seeding-your-database/">
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/acceptance-testing/">
    Acceptance testing
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/configuration/">
    Configuration
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/collections/">
    Collections
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/route-handlers/">
    Route handlers
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/database/">
    Database
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/factories/">
    Factories
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/fixtures/">
    Fixtures
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/models/">
    Models
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/schema/">
    Schema
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/serializers/">
    Serializers
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/shorthands/">
    Shorthands
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/manually-starting-mirage/">
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.3/simulating-cookie-responses/">
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.3/quickstart.md">
          <small>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s1">'/authors/:id/blog-posts'</span><span class="p">,</span> <span class="p">(</span><span class="nx">schema</span><span class="p">,</span> <span class="nx">request</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
  ...
  <span class="kd">let</span> <span class="nx">attrs</span> <span class="o">=</span> <span class="nx">JSON</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">request</span><span class="p">.</span><span class="nx">requestBody</span><span class="p">);</span>

  <span class="k">return</span> <span class="nx">author</span><span class="p">.</span><span class="nx">createBlogPost</span><span class="p">(</span><span class="nx">attrs</span><span class="p">);</span>
<span class="p">});</span>
</code></pre>
</div>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.3/changelog/">< Changelog</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.3/defining-routes/">Defining routes ></a>
