...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.8/models/">
    Models
  </a>
</li>
...
<li>
  <a class="Desktop-nav__item " href="/docs/v0.2.0-beta.8/shorthands/">
    Shorthands
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.8/models.md">
          <small>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">'/blog_posts'</span><span class="p">,</span> <span class="p">(</span><span class="nx">schema</span><span class="p">,</span> <span class="nx">request</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
  <span class="k">return</span> <span class="nx">schema</span><span class="p">.</span><span class="nx">blogPost</span><span class="p">.</span><span class="nx">all</span><span class="p">();</span>
<span class="p">});</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">'/blog_posts'</span><span class="p">,</span> <span class="p">({</span><span class="nx">blogPost</span><span class="p">},</span> <span class="nx">request</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
  <span class="k">return</span> <span class="nx">blogPost</span><span class="p">.</span><span class="nx">all</span><span class="p">();</span>
<span class="p">});</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">let</span> <span class="nx">post</span> <span class="o">=</span> <span class="nx">blogPost</span><span class="p">.</span><span class="k">new</span><span class="p">({</span><span class="na">title</span><span class="p">:</span> <span class="s1">'Lorem ipsum'</span><span class="p">});</span>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">let</span> <span class="nx">post</span> <span class="o">=</span> <span class="nx">blogPost</span><span class="p">.</span><span class="nx">create</span><span class="p">({</span><span class="na">title</span><span class="p">:</span> <span class="s1">'Lorem ipsum'</span><span class="p">});</span>
<span class="nx">post</span><span class="p">.</span><span class="nx">title</span><span class="p">;</span>   <span class="c1">// Lorem ipsum</span>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">let</span> <span class="nx">posts</span> <span class="o">=</span> <span class="nx">blogPost</span><span class="p">.</span><span class="nx">all</span><span class="p">();</span>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">let</span> <span class="nx">post</span> <span class="o">=</span> <span class="nx">blogPost</span><span class="p">.</span><span class="nx">find</span><span class="p">(</span><span class="mi">1</span><span class="p">);</span>
<span class="kd">let</span> <span class="nx">posts</span> <span class="o">=</span> <span class="nx">blogPost</span><span class="p">.</span><span class="nx">find</span><span class="p">([</span><span class="mi">1</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">]);</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">let</span> <span class="nx">post</span> <span class="o">=</span> <span class="nx">blogPost</span><span class="p">.</span><span class="nx">first</span><span class="p">();</span>
</code></pre>
</div>

<h3 id="wherequery">where(<em>query</em>)</h3>

<p>Return an array of models in the database matching the key-value pairs in <em>query</em>.</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">let</span> <span class="nx">posts</span> <span class="o">=</span> <span class="nx">blogPost</span><span class="p">.</span><span class="nx">where</span><span class="p">({</span><span class="na">published</span><span class="p">:</span> <span class="kc">true</span><span class="p">});</span>
</code></pre>
</div>
...
<p>This adds an <code class="highlighter-rouge">authorId</code> property to the <code class="highlighter-rouge">comment</code> model, as well as some methods for working with the associated <code class="highlighter-rouge">comments</code> collection:</p>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Model</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
  <span class="na">author</span><span class="p">:</span> <span class="nx">belongsTo</span><span class="p">(</span><span class="s2">"user"</span><span class="p">),</span>
  <span class="na">comments</span><span class="p">:</span> <span class="nx">hasMany</span><span class="p">(</span><span class="s2">"annotation"</span><span class="p">)</span>
<span class="p">});</span>
</code></pre>
</div>
...
<p>Sometimes a <code class="highlighter-rouge">hasMany</code> relationship can point to a model with multiple associations of the same type. You can use the <code class="highlighter-rouge">inverseOf</code> option to specify which property on the related model is the inverse of the given relationship:</p>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Model</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
  <span class="na">talks</span><span class="p">:</span> <span class="nx">hasMany</span><span class="p">(</span><span class="s1">'talk'</span><span class="p">,</span> <span class="p">{</span> <span class="na">inverseOf</span><span class="p">:</span> <span class="s1">'primaryEvent'</span> <span class="p">}),</span>
<span class="p">});</span>
</code></pre>
</div>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.8/fixtures/">< Fixtures</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.8/schema/">Schema ></a>
