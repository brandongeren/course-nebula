...
define('course-nebula/tests/controllers/login.jshint.lint-test', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/login.js should pass jshint.\ncontrollers/login.js: line 1, col 1, \'App\' is not defined.\ncontrollers/login.js: line 3, col 1, \'App\' is not defined.\ncontrollers/login.js: line 1, col 7, \'Ember\' is not defined.\ncontrollers/login.js: line 3, col 23, \'Ember\' is not defined.\ncontrollers/login.js: line 18, col 19, \'$\' is not defined.\n\n5 errors');
  });
});
