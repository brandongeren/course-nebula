...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.6/upgrading/">
    Upgrading
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.6/upgrading.md">
          <small>
...
mv app/mirage mirage
    ...
    <p>from the root of your project. Mirage’s directory is also <a href="http://localhost:4000/docs/v0.2.0-beta.6/configuration/#directory">customizable</a>, so you can also set an option and leave it under <code class="highlighter-rouge">/app</code>, if you’d like.</p>
  </li>
  <li>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.6/quickstart/">< Quickstart</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.6/defining-routes/">Defining routes ></a>
