...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.7/serializers/">
    Serializers
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.7/serializers.md">
          <small>
...
<p>Mirage ships with two named serializers. Use <strong>JsonApiSerializer</strong> to simulate JSON:API compliant servers:</p>
...
<p>Use <strong>ActiveModelSerializer</strong> to fake Rails backends that use AMS-style responses:</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.7/schema/">< Schema</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.7/shorthands/">Shorthands ></a>
