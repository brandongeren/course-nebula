...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.9/serializers/">
    Serializers
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.9/serializers.md">
          <small>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">JSONAPISerializer</span><span class="p">;</span>
  ...
  <li>
    ...
    <div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="c1">// mirage/serializers/application.js</span>
<span class="kr">import</span> <span class="p">{</span> <span class="nx">ActiveModelSerializer</span> <span class="p">}</span> <span class="nx">from</span> <span class="s1">'ember-cli-mirage'</span>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.9/schema/">< Schema</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.9/shorthands/">Shorthands ></a>
