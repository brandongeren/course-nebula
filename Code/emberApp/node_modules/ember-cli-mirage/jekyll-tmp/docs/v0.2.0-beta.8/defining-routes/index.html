...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.8/defining-routes/">
    Defining routes
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.8/defining-routes.md">
          <small>
...
<p>Mirage ships with two named serializers, JsonApiSerializer (used to implement <a href="http://jsonapi.org/">JSON:API</a>) and ActiveModelSerializer (used to simulate Rails servers using ActiveModel::Serializers). You should use these if your app’s backend will be built to conform to either standard.</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.8/upgrading/">< Upgrading</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.8/seeding-your-database/">Seeding your database ></a>
