...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.0-beta.5/upgrading/">
    Upgrading
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.0-beta.5/upgrading.md">
          <small>
...
<h2 id="x--02-upgrade-guide">0.1.x &gt; 0.2 Upgrade guide</h2>

<p>If you’re upgrading your Mirage server from v0.1.x to v0.2 (currently in Beta), here’s what you need to know:</p>
...
mv app/mirage mirage
    ...
    <p>from the root of your project. Mirage’s directory is also <a href="http://localhost:4000/docs/v0.2.0-beta.5/configuration/#directory">customizable</a>, so you can also set an option and leave it under <code class="highlighter-rouge">/app</code>, if you’d like.</p>
  </li>
  <li>
...
/mirage/fixtures/blog-post.js
    ...
    <p>You will then use the <a href="../serializers">new Serializer layer</a> to do things like format keys in your json payloads (or Mirage will do it for you).</p>
  </li>
  <li>
    ...
    <p>Wrong. We’re JavaScript developers here, people. It’s time to start using camelCase.</p>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Model</span><span class="p">.</span><span class="nx">etend</span><span class="p">({</span>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.0-beta.5/quickstart/">< Quickstart</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.0-beta.5/defining-routes/">Defining routes ></a>
